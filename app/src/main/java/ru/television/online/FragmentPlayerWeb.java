 ...
 * Use the {@link FragmentPlayerWeb#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentPlayerWeb extends Fragment {
    ...
    public FragmentPlayerWeb() {
        // Required empty public constructor
    }


    public static FragmentPlayerWeb newInstance(String name, String url, String url2, String url3, String idd, String select) {
        FragmentPlayerWeb fragment = new FragmentPlayerWeb();
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.sd, menu);
    }
